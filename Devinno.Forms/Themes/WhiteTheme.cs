...
namespace Devinno.Forms.Themes
{
    public class WhiteTheme : DvTheme
    {
        ...
        public static Color StaticForeColor { get; } = Color.Black;
        public static Color StaticBackColor { get; } = Color.FromArgb(220, 220, 220);
        public static Color StaticColor0 { get; } = Color.FromArgb(180, 180, 180);
        public static Color StaticColor1 { get; } = Color.FromArgb(195, 195, 195);
        public static Color StaticColor2 { get; } = Color.FromArgb(210, 210, 210);
        public static Color StaticColor3 { get; } = Color.FromArgb(225, 225, 225);
        public static Color StaticColor4 { get; } = Color.FromArgb(240, 240, 240);
        public static Color StaticColor5 { get; } = Color.FromArgb(250, 250, 250);
        public static Color StaticPointColor { get; } = Color.DodgerBlue;
        public static Color StaticFrameColor { get; } = Color.FromArgb(220, 220, 220);
        public static Color StaticScrollBarColor { get; } = Color.FromArgb(180, 180, 180);
        public static Color StaticScrollCursorColor { get; } = Color.FromArgb(250, 250, 250);
        public static Color StaticColumnColor { get; } = Color.FromArgb(150, 155, 160);
        #endregion

        #region Properties
        public override string ThemeName { get; } = "BlackTheme";

        public override Color ForeColor { get; set; } = WhiteTheme.StaticForeColor;
        public override Color BackColor { get; set; } = WhiteTheme.StaticBackColor;
        public override Color Color0 { get; set; } = WhiteTheme.StaticColor0;
        public override Color Color1 { get; set; } = WhiteTheme.StaticColor1;
        public override Color Color2 { get; set; } = WhiteTheme.StaticColor2;
        public override Color Color3 { get; set; } = WhiteTheme.StaticColor3;
        public override Color Color4 { get; set; } = WhiteTheme.StaticColor4;
        public override Color Color5 { get; set; } = WhiteTheme.StaticColor5;
        public override Color PointColor { get; set; } = WhiteTheme.StaticPointColor;
        public override Color FrameColor { get; set; } = WhiteTheme.StaticFrameColor;
        public override Color ScrollBarColor { get; set; } = WhiteTheme.StaticScrollBarColor;
        public override Color ScrollCursorColor { get; set; } = WhiteTheme.StaticScrollCursorColor;
        public override Color ColumnColor { get; set; } = WhiteTheme.StaticColumnColor;
        ...
        public override ThemeMenuColorTable MenuColorTable { get; } = new WhiteThemeMenuColorTable();
        #endregion
        ...
        public class WhiteThemeMenuColorTable : ThemeMenuColorTable
        {
            public override Color TextColor { get; set; } = Color.FromArgb(30, 30, 30);
            public override Color MenuStripColor { get; set; } = WhiteTheme.StaticColor1;
            public override Color MenuItemPressedColor { get; set; } = WhiteTheme.StaticColor1;
            public override Color ToolStripDropDownBackgroundColor { get; set; } = WhiteTheme.StaticColor1;

            public override Color MenuItemSelectedColor { get; set; } = WhiteTheme.StaticColor0;

            public override Color ImageMarginColor { get; set; } = Color.FromArgb(WhiteTheme.StaticColor1.R + 10, WhiteTheme.StaticColor1.G + 10, WhiteTheme.StaticColor1.B + 10);
            //public override Color ImageMarginColor { get; set; } = BlackTheme.StaticColor2;

            public override Color MenuItemBorderColor { get; set; } = WhiteTheme.StaticColor3;
            public override Color MenuBorderColor { get; set; } = WhiteTheme.StaticColor3;
            public override Color SeparatorColor { get; set; } = WhiteTheme.StaticColor3;
        }
        #endregion
    }
}
