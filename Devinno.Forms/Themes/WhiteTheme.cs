...
namespace Devinno.Forms.Themes
{
    ...
    public class WhiteTheme : DvTheme
    {
        ...
        public override float BorderBrightness { get; set; } = -0.4F;
        ...
        public override byte OutBevelAlpha { get; set; } = 60;
        public override byte InShadowAlpha { get; set; } = 20;
        public override float KeySpecialButtonBrightness => -0.2F;
        public override byte GradientLightAlpha => 40;
        ...
        public override Color BackColor => Util.FromArgb(180, 180, 180);
        public override Color ButtonColor => Util.FromArgb(180, 180, 180);
        public override Color LabelColor => Util.FromArgb(200, 200, 200);
        public override Color InputColor => Util.FromArgb(220, 220, 220);
        public override Color CheckBoxColor => Util.FromArgb(220, 220, 220);
        public override Color LampOnColor => Color.Red;
        public override Color LampOffColor => Util.FromArgb(150, 150, 150);
        public override Color StepOnColor => Color.Red;
        public override Color StepOffColor => Util.FromArgb(180, 180, 180);
        public override Color ConcaveBoxColor => Util.FromArgb(120, 120, 120);
        public override Color KnobColor => Util.FromArgb(180, 180, 180);
        ...
        public override Color PanelColor => Util.FromArgb(180, 180, 180);
        public override Color BorderPanelColor => Util.FromArgb(200,200,200);
        public override Color GroupBoxColor => Color.Black;
        public override Color TabBackColor => Util.FromArgb(200, 200, 200);
        public override Color TabPageColor => Util.FromArgb(180, 180, 180);
        public override Color RowColor => Util.FromArgb(220, 220, 220);
        public override Color ColumnColor => Util.FromArgb(200, 200, 200);
        public override Color ListBackColor => Util.FromArgb(170, 170, 170);
        public override Color WindowTitleColor => Util.FromArgb(200, 200, 200);
        public override Color CalendarDaysColor => Util.FromArgb(200, 200, 200);
        public override Color CalendarWeeksColor => Util.FromArgb(230, 230, 230);
        public override Color CalendarMonthColor => Util.FromArgb(200, 200, 200);
        public override Color CalendarSelectColor => Color.Teal;
        public override Color PointColor => Color.DeepSkyBlue;
        public override Color ScrollBarColor => Util.FromArgb(200, 200, 200);
        public override Color ScrollCursorOffColor => Util.FromArgb(90,90,90);
        public override Color ScrollCursorOnColor => Color.DeepSkyBlue;
        public override Color MenuNormalColor => Util.FromArgb(150, 150, 150);
        public override Color MenuSelectedColor => Color.Black;
    ...
    #endregion
    #region class : WhiteThemeMenuColorTable
    public class WhiteThemeMenuColorTable : ThemeMenuColorTable
    {
        public override Color TextColor { get; set; } = Util.FromArgb(30, 30, 30);
        public override Color MenuStripColor { get; set; } = Util.FromArgb(180, 180, 180);
        public override Color MenuItemPressedColor { get; set; } = Util.FromArgb(180, 180, 180);
        public override Color ToolStripDropDownBackgroundColor { get; set; } = Util.FromArgb(180, 180, 180);

        public override Color MenuItemSelectedColor { get; set; } = Util.FromArgb(220, 220, 220);

        public override Color ImageMarginColor { get; set; } = Util.FromArgb(180, 180, 180);
