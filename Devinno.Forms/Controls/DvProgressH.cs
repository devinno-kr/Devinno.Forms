    ...
    public class DvProgressH : DvControl
    {
        ...
        protected override void OnThemeDraw(PaintEventArgs e, DvTheme Theme)
        {
            ...
            Areas((rtContent, rtEmpty, rtFill) =>
            {
                ...
                if (rtFill.Width > 0)
                    Theme.DrawBox(e.Graphics, rtFill, BarColor, BorderColor, InnerBar ? RoundType.All : Round, Box.ButtonUp_V(true, ShadowGap));

                if (DrawText && rtFill.Width > 0)
                {
                    ...
                    var rt = Util.MakeRectangleAlign(Util.FromRect(rtFill, Reverse ? new Padding(5, 0, 0, 0) : new Padding(0, 0, 5, 0)), sz, Reverse ? DvContentAlignment.MiddleLeft : DvContentAlignment.MiddleRight);
        ...
        public void Areas(Action<RectangleF, RectangleF, RectangleF> act)
        {
            ...
            var wF = Convert.ToSingle(MathTool.Map(Value, Minimum, Maximum, 0, rtEmpty.Width));
