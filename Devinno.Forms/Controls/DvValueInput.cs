...
{
    public class DvValueInput : DvControl
    {
        #region Properties
        #region Icon
                ...
                case DvInputType.COMBO:
                    {
                        ...
                        if (DropState == DvDropState.Dropped || DropState == DvDropState.Dropping)
                        {
                            ...
                            if (dropContainer != null && dropContainer.Top <= vrt.Top) 
                                Theme.DrawBox(e.Graphics, ItemColor, BackColor, rtValueAll, RoundType.RB, BoxDrawOption.BORDER | BoxDrawOption.IN_BEVEL | BoxDrawOption.OUT_BEVEL);
                            else 
                                Theme.DrawBox(e.Graphics, ItemColor, BackColor, rtValueAll, RoundType.RT, BoxDrawOption.BORDER | BoxDrawOption.IN_BEVEL | BoxDrawOption.OUT_BEVEL);
                        }
                        else Theme.DrawBox(e.Graphics, ItemColor, BackColor, rtValueAll, RoundType.R, BoxDrawOption.BORDER | BoxDrawOption.IN_BEVEL | BoxDrawOption.OUT_SHADOW);
                ...
                case DvInputType.BOOL:
                    {
                        ...
                        if (!bDownOn)
                        {
                            ...
                            Theme.DrawTextShadow(e.Graphics, new DvIcon("fa-check") { IconSize = 12, Gap = 5 }, "ON", Font, ForeColor, cOnBG, rtOn);
                        ...
                        else
                        {
                            ...
                            Theme.DrawTextShadow(e.Graphics, new DvIcon("fa-check") { IconSize = 12, Gap = 5 }, "ON", Font, ForeColor.BrightnessTransmit(Theme.DownBright), cOnBG, new Rectangle(rtOn.X, rtOn.Y + Theme.ShadowGap, rtOn.Width, rtOn.Height));
                        }
                        ...
                        if (!bDownOff)
                        {
                            ...
                            Theme.DrawTextShadow(e.Graphics, new DvIcon("fa-times") { IconSize = 12, Gap = 5 }, "OFF", Font, ForeColor, cOffBG, rtOff);
                        }
                        else
                        {
                            ...
                            Theme.DrawTextShadow(e.Graphics, new DvIcon("fa-times") { IconSize = 12, Gap = 5 }, "OFF", Font, ForeColor.BrightnessTransmit(Theme.DownBright), cOffBG, new Rectangle(rtOff.X, rtOff.Y + Theme.ShadowGap, rtOff.Width, rtOff.Height));
                        }
                        #endregion
                    }
                    break;
        ...
        public class DropDownContainer : DvForm, IMessageFilter
        {
            ...
            public DropDownContainer(DvValueInput c)
            {
                #region Init
                this.BlankForm = true;
